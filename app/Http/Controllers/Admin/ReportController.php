...
class ReportController extends Controller
{
    ...
    {
        $report = Report::with(['user:id,name,department,hotel_id,avatar', 'items.task:id,name'])->findOrFail($id);
    ...
    public function index(Request $request)
    {
        ...
        $reports = (clone $baseQuery)->with(['user:id,name,department,hotel_id,avatar', 'items.task:id,name'])
        ...
        return view('admin.reports.summary', compact(
            'reports', 'hotels', 'startDate', 'endDate', 'hotelId', 'department', 'shiftId', 'staffId', 'staffList', 'currentHotel',
